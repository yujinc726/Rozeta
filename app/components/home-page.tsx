      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 pt-20 pb-32">
            ...
            <AnimatedSection>
              <Card className="relative overflow-hidden border-0 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 bg-white/80 backdrop-blur-sm">
                ...
                <CardContent className="relative p-8">
                  ...
                  <h3 className="text-2xl font-bold mb-3 text-gray-900">쉬운 녹음</h3>
            ...
            <AnimatedSection>
              <Card className="relative overflow-hidden border-0 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 bg-white/80 backdrop-blur-sm">
                ...
                <CardContent className="relative p-8">
                  ...
                  <h3 className="text-2xl font-bold mb-3 text-gray-900">AI 자동 정리</h3>
              <p className="text-gray-600 leading-relaxed">
                    녹음이 끝나면 AI가 알아서<br />
                    텍스트 변환부터 요약까지 완료
              </p>
            ...
            <AnimatedSection>
              <Card className="relative overflow-hidden border-0 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 bg-white/80 backdrop-blur-sm">
                ...
                <CardContent className="relative p-8">
                  ...
                  <h3 className="text-2xl font-bold mb-3 text-gray-900">완벽한 노트</h3>
              <p className="text-gray-600 leading-relaxed">
                    슬라이드별 핵심 요약과<br />
                    예상 문제까지 한 번에 확인
              </p>
        ...
        <AnimatedSection className="mt-32">
          ...
          <StaggerContainer className="space-y-8 max-w-4xl mx-auto">
            <div className="flex items-center gap-8 bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg">
              ...
              <div className="flex-1">
                <h3 className="text-xl font-semibold mb-2 text-gray-900">강의 시작 전, PDF 업로드</h3>
                <p className="text-gray-600">과목을 선택하고 강의 자료(PDF)를 업로드한 후 녹음을 시작하세요</p>
              </div>
            ...
            <div className="flex items-center gap-8 bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg">
              ...
              <div className="flex-1">
                <h3 className="text-xl font-semibold mb-2 text-gray-900">강의 중, 슬라이드 동기화</h3>
                <p className="text-gray-600">교수님이 슬라이드를 넘길 때마다 '다음 슬라이드' 버튼만 클릭</p>
              </div>
              <ArrowRight className="w-12 h-12 text-purple-300" />
            </div>
            ...
            <div className="flex items-center gap-8 bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg">
              ...
              <div className="flex-1">
                <h3 className="text-xl font-semibold mb-2 text-gray-900">강의 후, 자동 생성된 노트 확인</h3>
                <p className="text-gray-600">AI가 슬라이드별 요약, 핵심 키워드, 예상 문제를 자동으로 정리</p>
              </div>
            ...
            <Card className="border-0 shadow-xl bg-white/80 backdrop-blur-sm">
              <CardContent className="p-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-2 text-gray-900">과목별 체계적 관리</h3>
                    <p className="text-gray-600">모든 녹음과 노트를 과목별로 정리하여 한눈에 확인하고 쉽게 찾아볼 수 있습니다</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-xl bg-white/80 backdrop-blur-sm">
              <CardContent className="p-8">
                <div className="flex items-start gap-4">
                  <CheckCircle2 className="w-8 h-8 text-purple-600 flex-shrink-0 mt-1" />
                  <div>
                    <h3 className="text-xl font-bold mb-2 text-gray-900">핵심만 쏙쏙 정리</h3>
                    <p className="text-gray-600">방대한 강의 내용 중 중요한 부분만 AI가 추출하여 시험 대비 시간을 대폭 단축</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-xl bg-white/80 backdrop-blur-sm">
              <CardContent className="p-8">
                <div className="flex items-start gap-4">
                  <CheckCircle2 className="w-8 h-8 text-purple-600 flex-shrink-0 mt-1" />
                  <div>
                    <h3 className="text-xl font-bold mb-2 text-gray-900">예상 문제로 실전 대비</h3>
                    <p className="text-gray-600">각 슬라이드의 내용을 바탕으로 AI가 생성한 예상 문제로 미리 시험을 준비하세요</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-xl bg-white/80 backdrop-blur-sm">
              <CardContent className="p-8">
                <div className="flex items-start gap-4">
                  <CheckCircle2 className="w-8 h-8 text-purple-600 flex-shrink-0 mt-1" />
                  <div>
                    <h3 className="text-xl font-bold mb-2 text-gray-900">언제 어디서나 복습</h3>
                    <p className="text-gray-600">클라우드에 저장되어 PC, 태블릿, 스마트폰 어디서든 학습 가능</p>
        </div>
      </div>
              </CardContent>
            </Card>
      ...
      {/* CTA Section */}
        <AnimatedSection className="mt-32 mb-16">
          <div className="relative">
            ...
            {/* Content */}
            <div className="relative bg-white/70 backdrop-blur-sm rounded-3xl shadow-2xl p-16 text-center border border-purple-100">
        ...
        <Button
                    size="lg" 
          onClick={onGetStarted}
                    className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white px-10 py-6 text-lg rounded-full shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105"
                  >
